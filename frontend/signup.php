...
<body>
    <form action="../backend/traitement_formulaire.php" method="POST" class="form" id="multiStepForm" data-parsley-validate enctype="multipart/form-data">
        ...
        <div class="form-step" data-parsley-group="step2">
            ...
            <input type="range" id="radius-range" min="0" max="8" value="0" step="1" name="range">
        ...
        <div class="form-step" data-parsley-group="step3">
            <div class="input-group">
                ...
                <input type="file" id="profile-pic" name="profile-pic" accept="image/*" style="display: none;" hidden>
